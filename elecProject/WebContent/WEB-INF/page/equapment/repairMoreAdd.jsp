...
<form name="Form1" method="post" >
	...
	<tr>
		<td width="30%" height="100%">
			...
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01" style="width: 28%">设备名称：</td>
				<td align="left" bgColor="#f5fafe" class="ta_01" style="width: 64%">
					<s:textfield name="DevName" id="DevName" size="21" onClick="gotosearchDevice() " ></s:textfield></td> 
			</tr>
			...
			<tr>
				<td colspan="2">
					<IFRAME src="${pageContext.request.contextPath }/equapment/elecRepairAction_moreAddList.do" name="dtype" id="dtype" frameBorder=0 width=335 scrolling=auto height=220></IFRAME>
					</td>
				</tr>
			</table>
			</fieldset>
		...
		<table cellSpacing="1" width=100% cellPadding="5" height="320" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0" >
			...
			<tr>
				...
				<td bgColor="#f5fafe" class="ta_01">
				<s:textarea name="Record" cssStyle="WIDTH:95%" rows="4" cols="52"></s:textarea>
				</td>
			</tr>
		...
		<tr>
			<td height="15" colspan="2" align="center" bgColor="#f5fafe" class="ta_01" style="width: 100%">
