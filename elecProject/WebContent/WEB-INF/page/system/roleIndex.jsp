												...
												<s:iterator value="#request.popedomList" var="popedom">
													...
													<s:if test="#popedom.isParent">
														...
														<td class="ta_01"  align="left" width="18%" height="22" background="../images/tablehead.jpg" >
															<input type="checkbox"  name="selectoper" id="<s:property value="#popedom.mid"/>_<s:property value="#popedom.mid"/>" value="" onClick='goSelect(this.id)' >
													...
													<s:else>
														...
														<div>
														<input type="checkbox"  name="selectoper" id="<s:property value="#popedom.pid"/>_<s:property value="#popedom.mid"/>" value="" onClick='goSelect(this.id)' >
														<s:property value="#popedom.name"/>
														</div>
													</s:else>
												</s:iterator>
