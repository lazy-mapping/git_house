	...
	<s:if test="#request.uploadList!=null && #request.uploadList.size()>0">
		<s:iterator value="#request.uploadList" var="upload" status="st">
			<tr onmouseover="this.style.backgroundColor = 'white'"
				...
				<td class="ta_01" align="center" width="80%">
					<a href="#" onclick="openWindow('${pageContext.request.contextPath }/datachart/elecFileUploadAction_download.do?seqId=<s:property value="#upload.seqId"/>','700','400');"><s:property value="#upload.fileName"/></a>
				</td>
			</tr>
		</s:iterator>
	</s:if>
